      ...
      <section style={{ minHeight: '60vh', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', background: 'linear-gradient(120deg, #fff 60%, #f6f4ff 100%)', padding: '80px 0 40px 0' }}>
        <div style={{ maxWidth: 800, background: 'rgba(255,255,255,0.97)', borderRadius: 28, boxShadow: '0 8px 40px #ed469033', padding: '48px 36px 36px 36px', textAlign: 'center', border: '1.5px solid #e6eaff', margin: '0 auto' }}>
          ...
          <p style={{ color: '#6E6E6E', fontSize: 19, marginBottom: 18, fontWeight: 500, lineHeight: 1.7 }}>
            This website was developed as part of the DevOps and Enterprise Systems Project for Flinders University. Our team of twelve dedicated students collaborated to deliver a robust, full-stack web application that demonstrates real-world principles of modern software engineering.
          </p>
          <p style={{ color: '#232323', fontSize: 17, marginBottom: 18, fontWeight: 400, lineHeight: 1.7 }}>
            Throughout this project, we actively applied DevOps concepts, integrating continuous integration and continuous deployment (CI/CD) pipelines, version control best practices, and automated testing to ensure code quality and rapid, reliable delivery. Our workflow embraced Agile methodology, enabling us to iterate quickly, adapt to challenges, and foster strong team communication with regular stand-ups, sprints, and retrospectives.
          </p>
          <p style={{ color: '#232323', fontSize: 17, fontWeight: 400, lineHeight: 1.7 }}>
            Our collective goal was to build an enterprise-grade solution that not only meets project requirements, but also exemplifies industry standards for collaboration, automation, and innovation in software development.
          </p>
        </div>
      </section>
