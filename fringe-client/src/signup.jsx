          ...
          <div className="login-card-left">
            <div className="content">
              ...
              <form className="login-form" onSubmit={async (e) => {
                ...
                <button type="button" className="login-google-btn" onClick={() => window.location.href = "http://localhost:5001/api/auth/google"}>
                  <span className="login-btn-icon"><i className="fab fa-google"></i></span> Continue with Google
                </button>
                <button type="button" className="login-facebook-btn" onClick={() => window.location.href = "http://localhost:5001/api/auth/facebook"}>
